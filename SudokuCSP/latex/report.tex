...
Naked Pairs is the third constraint propagation technique we introduce in our programme. Similarly to the previously discussed technique, we look for unique values. However, with naked pairs, we look for a combination of two values in a set of constrained variables (i.e. row,column,region).
