...
The blocking rule should only be applied when no other rules are applicable on the branch to guarantee termination and completeness of the algorithm. It is easy to show
...
$\rightarrow$ references? wat? $\leftarrow$
