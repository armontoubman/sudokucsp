...
\begin{table}[htbp]
    ...
    \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        \hline
        \cellcolor{red!75!white}7 & 9 & 4 & \{2, 5\} & \{2, 5\} & \cellcolor{red!50!white} 6 & 1 & 3 & \cellcolor{red!25!white} 8\\
        \hline
        \end{tabular}
    \end{center}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        \hline
        \cellcolor[wave]{378}\{7, 8\} & 9 & 4 & \{2, 5\} & \{2, 5\} & \{2, 5, 6\} & 1 & 3 & \cellcolor[wave]{400}\{7, 8\}\\
        \hline
        \end{tabular}
    \end{center}
\end{table}
